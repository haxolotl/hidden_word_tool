...
def get_corpus_data():
    """Download and load corpora at startup."""
    if not CORPUS_DATA:
        import nltk
        for name in ['brown', 'gutenberg', 'reuters', 'abc', 'webtext']:
        ...
        CORPUS_DATA['all'] = ' '.join(CORPUS_DATA[name] for name in ['brown', 'gutenberg', 'reuters', 'abc', 'webtext'])
